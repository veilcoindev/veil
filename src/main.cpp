...
const string strMessageMagic = "VeilCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            int64_t nSubsidy = 3000 * COIN;

            if(nBestHeight == 0)
            {
            nSubsidy = 840000000 * COIN;
            }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "VeilCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1495705241, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "headline from today";
        CTransaction txNew;
        txNew.nTime = 1495705241;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1495705241;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 257897 : 257897;
        ...
        assert(block.hashMerkleRoot == uint256("0xfd30c917a5a9f220440ea883d76aa6e901f74d2aa24938db70e6aba7eff476e9"));
...
unsigned char pchMessageStart[4] = { 0x70, 0xb0, 0x96, 0xd5 };
